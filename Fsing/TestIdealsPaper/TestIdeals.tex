...
which is the basis for many constructions and definitions.  Notably, Frobenius can be used to detect whether a ring is regular \cite{KunzCharacterizationsOfRegularLocalRings}, and further, and   
