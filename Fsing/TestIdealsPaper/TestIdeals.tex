...
%
\pedro{
   Should we call this $N$ the $p^e$-th Frobenius root of $M$, and denote it by $M^{[1/p^e]}$?
}
%
...
After the test element $c$ has been identified, we pull back the ideal $\omega_R$ to an ideal $J = S$.  Next, we compute the following ascending sequence of ideals:
\begin{equation}
