...
This package includes a method for checking whether a ring of finite type over a
prime field is $F$-injective.
...
\rightarrow R^{1/p}$ using {\tt frobPFMap}. Next the algorithm computes
...
\begin{definition}
A ring $R$ is called \emph{strongly $F$-regular} if $\tau(R) = R$.
\end{definition}
...
We can also perform these types of computations for pairs.
