...
(cf.~\cite[\S 2]{BlickleMustataSmithDiscretenessAndRationalityOfFThresholds} and \cite[\S 5]{KatzmanParameterTestIdealOfCMRings}).  They also exist in $F$-finite regular rings.  In all such rings, we can also describe Frobenius roots as follows.  In a regular ring, 
