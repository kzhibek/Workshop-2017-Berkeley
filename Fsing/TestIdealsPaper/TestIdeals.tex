...
o8 : Ideal of R
i10 :  u = intersect( (frobenius I ):I, ( frobenius omega ):omega );
o10 : Ideal of R
i11 :  u = compress( (gens u) % gens( frobenius I) )
o11 = | a3bc+a3bd+a2cde+abcde+abd2e+b2d2e+cd2e2+d3e2 |
              1       1
o11 : Matrix R  <--- R
i12 :  u = first first entries u
       3       3       2                         2     2 2       2 2    3 2
o12 = a b*c + a b*d + a c*d*e + a*b*c*d*e + a*b*d e + b d e + c*d e  + d e
o12 : R
\end{MyVerbatim}
}
\medskip
...
{\small
\begin{MyVerbatim}
i13 : L = compatibleIdeals u
              3       3       2                         2     2 2       2 2
o13 = {ideal(a b*c + a b*d + a c*d*e + a*b*c*d*e + a*b*d e + b d e + c*d e  +
      -------------------------------------------------------------------------
       3 2                  2
...
i14 : unique apply(L, J-> (J:omega))
              3       3       2                         2     2 2       2 2
o14 = {ideal(a b*c + a b*d + a c*d*e + a*b*c*d*e + a*b*d e + b d e + c*d e  +
      -------------------------------------------------------------------------
       3 2                  2
