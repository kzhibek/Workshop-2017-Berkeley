...
and the Frobenius map on  $H^2_{\mathfrak{m}} (R/I)$ induced from Frobeniuson $R$
...
$E=E_{R_\mathfrak{m}}(R_{\mathfrak{m}}/\mathfrak{m})=H^n_{\mathfrak{m}} (R)$, and let $T: E \rightarrow E$ be the $p^e$-linear map
